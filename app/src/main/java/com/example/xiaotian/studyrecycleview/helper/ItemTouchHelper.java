...
package com.example.xiaotian.studyrecycleview.helper;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link ItemTouchUIUtilImpl} that is used by the {@link Callback} class for
         * visual
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            if (mOnItemLongPressListener != null) {
                mOnItemLongPressListener.onItemLongPress(e);
            }
    ...
    public interface OnItemLongPressListener {
        void onItemLongPress(MotionEvent e);
    }
    private OnItemLongPressListener mOnItemLongPressListener;

    public void setOnItemLongPressListener(OnItemLongPressListener mOnItemLongPressListener) {
